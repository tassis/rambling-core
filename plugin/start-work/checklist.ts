...
function parseTaskShape(rawTask: ParsedChecklistTask, index: number): StartWorkChecklistTask {
  ...
  const blockedBy = rawTask.blocked_by === undefined || rawTask.blocked_by === null ? null : String(rawTask.blocked_by)
  const unblockWhen = rawTask.unblock_when === undefined || rawTask.unblock_when === null ? null : String(rawTask.unblock_when)
  ...
  return {
    ...
    next_action: rawTask.next_action === undefined || rawTask.next_action === null ? null : String(rawTask.next_action),
    last_update: rawTask.last_update === undefined || rawTask.last_update === null ? null : String(rawTask.last_update),
  }
}
